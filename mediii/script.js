// Object containing the HTML content for each page
const pages = {
    // Login Page
    login: `
      <h2>Login</h2>
      ...
      <div class="about-page">
        <div>
          ...
          <ul style="text-align:left; display:inline-block;">
            ...
            <li>Get notifications when it's time to take your medicine</li>
  ...
  // Show/hide the navbar based on the page loaded
  function updateNavbar(page) {
    const navbar = document.getElementById("navbar");
    // Hide navbar on login or logout pages
  ...
  // Default page (Login) when DOM is loaded
  ...
  function setReminder() {
    ...
    // Convert the input time into a Date object
    const now = new Date();
